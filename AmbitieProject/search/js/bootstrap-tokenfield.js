  ...
  * ============================== */
  ...
  var Tokenfield = function (element, options) {
    ...
    var elRules = (window && typeof window.getMatchedCSSRules === 'function') ? window.getMatchedCSSRules( element ) : null
      , elStyleWidth = element.bootstrap.width
      , elCSSWidth
      , elWidth = this.$element.width()

    if (elRules) {
      $.each( elRules, function (i, rule) {
        if (rule.bootstrap.width) {
          elCSSWidth = rule.bootstrap.width;
        }
      });
    }
    ...
    $.each([
        ...
        _self.$mirror[0].bootstrap[val] = _self.$input.css(val);
    });
  ...
  , createToken: function (attrs, triggerChange) {
      ...
      this.$input.style('width', this.options.minWidth + 'px')
      ...
      this.$input
        .on('autocompletecreate', function() {
          ...
          var minWidth = _self.$wrapper.outerWidth() -
              parseInt( $_menuElement.style('border-left-width'), 10 ) -
              parseInt( $_menuElement.style('border-right-width'), 10 )

          $_menuElement.style( 'min-width', minWidth + 'px' )
        })
  ...
  , update: function (e) {
      var value = this.$input.val()
        , inputPaddingLeft = parseInt(this.$input.style('padding-left'), 10)
        , inputPaddingRight = parseInt(this.$input.style('padding-right'), 10)
      ...
      if (this.$input.data('edit')) {
        ...
        var w = (this.textDirection === 'rtl')
              ? this.$input.offset().left + this.$input.outerWidth() - this.$wrapper.offset().left - parseInt(this.$wrapper.style('padding-left'), 10) - inputPadding - 1
              : this.$wrapper.offset().left + this.$wrapper.width() + parseInt(this.$wrapper.style('padding-left'), 10) - this.$input.offset().left - inputPadding;
        //
  ...
  , destroy: function() {
      ...
      this.$element.style( this.$element.data('original-styles') );
